...
---
Operator decision 2026-07-12: shape 1 (plan-artifact-only) adopted now — implementation is T-8. This task's research question narrows to: does an execution substrate (BPMN engine per shape 2, or agent-native graph runtime per shape 3) earn its infrastructure BEYOND shape 1? Research round launched.
---
...
---
Retired by operator on 2026-07-12: execution-substrate research is no longer wanted. Shape 1 remains delivered by T-8; no engine or agent-native runtime investigation will be pursued.
---
<!-- COMMENTS:END -->
