...
Per doc-42: slim the delivery choreography that survived Phase 4, using the T-35 delivery evidence. Attaching an existing checkout (including harness-created worktrees) becomes the documented default; change labels become agent-chosen and operator-renameable; the handoff verifies the notification result instead of assuming it.
