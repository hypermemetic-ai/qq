...
Operator clarification on the alt+o bug (2026-07-16): the real defect is that snap does not JUMP anywhere useful — in a space with no claude orchestrator it must jump to the project home orchestrator, not merely report accurate text (T-56 fixed only the false message).
