...
The diagram is the approved execution contract. Post-landing execution is recorded in `assets/doc-23/completions.json`; the generated report is stored at `assets/doc-23/conformance.md`.
...
| --- | --- | --- | --- | --- |
| scope_aligned | Recovery scope aligned | StartEvent | done | Evidence: T-13 description/ACs and operator approval of the rendered doc-23 plan |
| revalidate_inventory | Revalidate Git inventory | ServiceTask | done | Evidence: T-13 implementation notes: six clean merged auxiliary worktrees, three stashes, 15 WIP refs, and unreferenced 8ed35f2 revalidated before mutation |
...
| verify_recovery | Run recovery checks | ServiceTask | done | Evidence: T-13 implementation notes: fail-fast JSON/TOML, Backlog linkage, stash-equivalence, BPMN, Herdr semantic, and diff-hygiene checks |
...
| clean_local_git | Remove obsolete local Git state | ServiceTask | done | Evidence: T-13 notes: six worktrees/branches, three stashes, and 15 refs/wip removed; primary main cleaned and fast-forwarded |
...
| finalize_change | Finalize Task and PR checks | ServiceTask | done | Evidence: T-13 marked Done with five checked ACs in commit 0749643; PR #43 merge state CLEAN with no configured checks |
