---
id: doc-29
title: Plan — Teach OpenWiki generation to author helpful BPMN
type: other
...
Executed completions are recorded in `assets/doc-29/completions.json`; the standalone report is `assets/doc-29/conformance.md`.
