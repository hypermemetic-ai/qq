...
- 2026-07-20: delegate network egress accepted as open under Landstrip 0.17.x with declared threat model; inert domain-list fields removed from policies; revisit trigger ticketed as T-122: decision-8 (operator-approved alignment exchange, this session). The pilot's network-route approval semantics are retired as unimplementable under Landstrip 0.17.x.
