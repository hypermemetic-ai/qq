...
These globally registered Pi extensions constrain context growth and intercept unsafe or unproductive actions. Registration is centralized in `extensions/index.ts`; this page covers their local behavior rather than general runtime activation.
