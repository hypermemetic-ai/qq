...
| `sketch`, `note`, `delegate` | architect-only board/workshop tools | [Workshop delegation](../workflows/workshops.md) |
...
| Backlog write guard, repeated-turn loop guard | automatic Pi event guards | [Session safety](../agent-runtime/session-safety.md) |
