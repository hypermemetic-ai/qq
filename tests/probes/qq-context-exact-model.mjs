...
try {
  ...
  if (JSON.stringify(profile.profile) !== JSON.stringify({ provider: "openai-codex", model: "gpt-5.6-sol", effort: "xhigh", serviceClass: "priority" })) refuse("canonical compactor profile no longer names the approved exact model/options");
